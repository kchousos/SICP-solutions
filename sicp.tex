...
\section*{Chapter 1}
\label{sec:org70fdfd2}

\subsection*{1.01}
\label{sec:orgbd64663}
...
(define (proc a b c)
  (cond ((and (> a c) (> b c))
        ...
        ((and (> b a) (> c a))
         (+ (* b b) (* c c)))))
\end{minted}
\caption{\label{lst:org6358acf}Sum of the two-out-of-three larger numbers}
\end{listing}
